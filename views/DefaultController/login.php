...
<div class="row mt-5" style="margin-left: 100px; margin-right: 100px; background-color: whitesmoke; border-radius: 25px;">
    ...
    <div class="container col mb-4 mt-3 border-left" style="line-height: 2px">
        ...
        <div class="input-group mb-3">
            ...
            <input type="password" class="form-control" placeholder="Confirm Password" aria-label="Confirm Password" aria-describedby="basic-addon3" required>
        </div>
